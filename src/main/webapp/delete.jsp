...
<script type="text/javascript">
  ...
  alert("gg");
   ...
   if(ob.readyState==4)
   {
   document.getElementById("result2").innerHTML=ob.responseText;
  ...
  alert("gg1");
	...
	function retrieve1(str) {
		...
		function fun5() {
			...
			if (ob.readyState == 4) {
				document.getElementById("result3").innerHTML = ob.responseText;
			}
		}
	}
</script>
	...
	<div id="page">
			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<div class="entry">
						   <center>
        <s:form action="deletaction">
               <table>
         <tr><s:select label="DISTRICT" name="district" list="mapForSelect" headerkey="-1" headervalue="---please select" onchange="retrieve(this.value);"> 
         </s:select> <td>BLOCK</td><td id="result2"><br></td>
         <td>DEPOT</td><td id="result3"><br></td></tr>
         
      
         
         <tr>
         <td Align=CENTER>Rice Transaction<input type="radio" name="r" value="rice"/></td>
         <td Align=CENTER>Wheat Transaction<input type="radio" name="r" value="wheat"/></td>
         <!--<td Align=CENTER>Sugar Transaction<input type="radio" name="r" value="sugar"/></td>-->
         </tr>
         </table>
        <td><br></td> 
        <td><br></td> 
        ...
        <s:submit value="show"></s:submit>
					...
					<div style="clear: both;">&nbsp;</div>
							...
							<br/>
							<ul>
								<li><a href="#"><li><a href="http://ibnlive.in.com/generalnewsfeed/news/delhi-govt-launches-epds-system-for-greater-transparency/963576.html">DL: Delhi Government launches e-PDS system for greater transparency</a></li>
								...
								<li><a href="http://ww5.foodorissa.in/Download/Revised_Operational_Guidelines_for_Departmental_Storage_Operations_as_on_30.04.2012.pdf">Departmental storage operation with Door Delivery of Food Stock..02.05.2012</a></li></a></li>
