			...
			<div id="page-bgtop">
				<div id="page-bgbtm">
					<div id="content">
						...
						<div class="post">
							<h2 class="title">
								<font color="blue">DEPOT REGISTRATION</font>
							</h2>
							<div class="entry">
								<table width="231" height="205">
									<s:form action="b">
										<tr>
											<td>--><a href="depotregistration.jsp">Depot
													Registration</a></td>
										</tr>
										<br />
										<tr>
											<td>--><a href="addRRC">RRC Opening</a></td>
										</tr>
										<br />
										<tr>
											<td>--><a href="deletdist">Delete Message</a></td>
										</tr>
										<br />
									</s:form>
								</table>
						...
						<ul>
							<li><a
								href="http://ibnlive.in.com/generalnewsfeed/news/delhi-govt-launches-epds-system-for-greater-transparency/963576.html">DL:
									Delhi Government launches e-PDS system for greater transparency</a></li>
							<li><a
							...
							<li><a
								href="http://ww5.foodorissa.in/Download/Revised_Operational_Guidelines_for_Departmental_Storage_Operations_as_on_30.04.2012.pdf">Departmental
									storage operation with Door Delivery of Food Stock..02.05.2012</a></li>
