		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><font color="blue">DEPOT REGISTRATION</font></h2>
						<div class="entry">
						<table>
						<s:form action="c">
						<tr><td>
						<a href="add">ADD</a></td></tr><br/>
						<tr><td><a href="view">UPDATE<br></a></td></tr><br/>
						<tr><td><br></td></tr><br/>
