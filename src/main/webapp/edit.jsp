			...
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						...
						<center>
         <s:form action="updateaction1">
         <s:hidden name="depot_id"/>
        <s:textfield name="district" label="DISTRICT"/>
        <s:textfield name="block" label=" BLOCK"/>
         <s:textfield name="location" label="LOCATION"/>
         <s:textfield name="capacity" label="CAPACITY"/>
         <s:textfield name="hiredby" label="HIRED BY"/>
         <s:textfield name="depotRRCinownedby" label="DEPOT RRC IN OWNED BY"/>
         <s:textfield name="depotRRCinmanagedby" label="DEPOT RRC IN MANAGED BY"/>
