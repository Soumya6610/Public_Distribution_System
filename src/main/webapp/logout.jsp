...
window.document.frm.submit();
  ...
  <body bgcolor="" onload="fun()">
<div id="wrapper">
	<div id="header">
		<div id="logo"><img alt="" src="images/Mhead-bg11.jpg" width="910" height="85"></div>
		<div id="menu">
			<ul>
  ...
  <form method="post" action="index.jsp" name="frm">
  
  
  </form></div>
					
							<h2><br></h2><h2>PDS News</h2>
							<br/>
							<ul>
								...
								<li><a href="http://ww5.foodorissa.in/Download/Revised_Operational_Guidelines_for_Departmental_Storage_Operations_as_on_30.04.2012.pdf">Departmental storage operation with Door Delivery ofFood Stock..02.05.2012</a></li>
