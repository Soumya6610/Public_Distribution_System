...
<%@page import= "com.opensymphony.xwork2.ActionContext,pds.login" %>
<%
	...
	<div id="page">
		...
		for(int i=0;i<al.size();i++){
		  ...
		  <tr>
			...
			<td><%=al.get(i).getRice_issue()%></td>
			<td><%=al.get(i).getRice_receive()%></td>
			<td><a href="deletemsg?id=<%=al.get(i).getDepo_id()%>">Delete</a></td>
