			...
			<div id="page-bgtop">
				<div id="page-bgbtm">
					<div id="content">
						<div class="post">
							<h2 class="title">
								<a href="#">Welcome to Public Distribution System </a>
							</h2>
						...
						<div class="post">
							<h2 class="title">
								<a href="#">PUBLIC DISTRIBUTION SYSTEM</a>
							</h2>
							<div class="entry">
								<center>
									<s:form action="RRCupdate">

										<table>
											<s:hidden name="result1"></s:hidden>
											<tr>
												<td><s:textfield name="block" label="BLOCK" /></td>
											</tr>
											<tr>
												<td><s:textfield name="location" label="LOCATION" /></td>
											</tr>
											...
											<tr>
												<td><s:textfield name="openingbalancerice"
														label="OPENING BALANCE  RICE" /></td>
											</tr>
											<tr>
												<td><s:textfield name="openingbalancewheat"
														label="OPENING BALANCE WHEAT" /></td>
											</tr>
											<tr>
												<td><s:textfield name="openingbalancesugar"
														label="OPENING BALANCE SUGAR" /></td>
											</tr>
						...
						<br />
						<ul>
							<li><a href="#">DL: Delhi Government launches e-PDS
									system for greater transparency</a></li>
							<li><a href="#">UP:Food and Civil supplies Department:
									2012-13</a></li>
							<li><a href="#">Departmental storage operation with Door
									Delivery of Food Stock..02.05.2012</a></li>
						...
						<ul>
							...
							<li>
								...
								<p>
									...
									several states across the country. Food Corporation of India, a
									Government-owned corporation, procures, maintains the Public
