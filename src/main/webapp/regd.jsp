		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><font color="blue">REGISTRATION REPORT<br></font></h2>
						<div class="entry">
						  <center>
         <ul>
                                <!-- CSS Tabs -->
<li><a id="current" href="repot">Depot Registration</a></li>
<li><a id="current" href="regdetail">Registration Details</a></li>
<li><a id="current" href="statushire">Status Report of Depot Hired</a></li>
<li><a id="current" href="seletdist1">Closing Balance Report</a></li>
