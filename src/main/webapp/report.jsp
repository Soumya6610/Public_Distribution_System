			...
			<div id="page-bgtop">
				<div id="page-bgbtm">
					<div id="content">
							...
							<div class="entry">
								<center>
									<ul>
										...
										<li><a id="current" href="regd.jsp">Registration
												Report</a></li>
										<li><a id="current" href="rice.jsp">Rice Transfer</a></li>
										<li><a id="current" href="wheat.jsp">Wheat Transfer</a></li>
						...
						<ul>
							<li><a
								href="http://ibnlive.in.com/generalnewsfeed/news/delhi-govt-launches-epds-system-for-greater-transparency/963576.html"><li><a
										href="http://ibnlive.in.com/generalnewsfeed/news/delhi-govt-launches-epds-system-for-greater-transparency/963576.html">DL:
											Delhi Government launches e-PDS system for greater
											transparency</a></li>
									<li><a
										href="http://fcs.up.nic.in/upfood/fcsportal/information/Nivida_Suchna.aspx">UP:Food
											and Civil supplies Department: 2012-13</a></li>
									<li><a
										href="http://ww5.foodorissa.in/Download/Revised_Operational_Guidelines_for_Departmental_Storage_Operations_as_on_30.04.2012.pdf">Departmental
											storage operation with Door Delivery of Food
											Stock..02.05.2012</a></li></a></li>
