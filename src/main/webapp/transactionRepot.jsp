...
<script type="text/javascript">
 ...
 <body bgcolor=""><br><div id="wrapper">
		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><a href="#">TRANSACTION</a></h2>
						<div class="entry">
						
					    <center>
        <s:form action="inchargeaction" name="fr" onsubmit="return func()">
        
        
       
        <table>
        <tr><td><s:textfield name="date" label="Enter Date"/></td></tr>
        <tr><td><s:textfield name="depot_id" label="Enter your depotid"/></td></tr>
        <tr><td><s:textfield name="rice_issue" label="Rice Issue    (QT)"/></td></tr>
        <tr><td><s:textfield name="rice_receive" label="Rice Receive(QT)"/></td></tr>
        <tr><td><s:textfield name="wheat_issue" label="Wheat Issue  (QT)"/></td></tr>
        <tr><td><s:textfield name="wheat_receive" label="Wheat Receive(QT)"/></td></tr>        
...
function func()
{
var a=document.forms["fr"]["date"].value;
var b=document.forms["fr"]["depot_id"].value;
var c=document.forms["fr"]["rice_issue"].value;
var d=document.forms["fr"]["rice_receive"].value;
var e=document.forms["fr"]["wheat_issue"].value;
var f=document.forms["fr"]["wheat_receive"].value;
var g=document.forms["fr"]["sugar_issue"].value;
var h=document.forms["fr"]["sugar_receive"].value;
if(a=="")
{
alert("Enter date");
  document.forms["fr"]["date"].focus();
return false;
}
if(b=="")
{
...
if(d=="")
{
alert("Enter Quantity of rice received");
  document.forms["fr"]["rice_receive"].focus();
return false;
}
           if(e=="")
{
...
if(f=="")
{
alert("Enter quantity of wheat received");
  document.forms["fr"]["wheat_receive"].focus();
return false;
}
if(g=="")
{
...
if(h=="")
{
alert("Enter quantity of sugar received");
  document.forms["fr"]["sugar_receive"].focus();
return false;
}
