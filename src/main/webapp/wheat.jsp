		...
		<div id="page-bgtop">
			<div id="page-bgbtm">
				<div id="content">
					...
					<div class="post">
						<h2 class="title"><font color="blue">wheat transfer<br></font></h2>
						<div class="entry">
					
         <center> 
           <table>
           <s:form action="wheat">
         <tr><td><s:select name="dist" list="{'Angul','Jharsuguda','Balasore','Sambalpur'}" label="Select District:"/></td>
          <tr><td></td><td><s:submit value="Show"></s:submit></td></tr>         
					...
					<div style="clear: both;">&nbsp;</div>
							...
							<ul>
								...
								<li><a href="http://www.foodorissa.in/Download/Revised_Operational_Guidelines_for_Departmental_Storage_Operations_as_on_30.04.2012.pdf">Departmental storage operation with Door Delivery of Food Stock..02.05.2012</a></li>
